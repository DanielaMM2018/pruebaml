"""
041_supervised_model_ordinal.py
--------------------------------

Objetivo:
Entrenar un modelo supervisado ORDINAL para pronosticar
la intensidad de compra en la categoría TECNOLOGÍA.

El target original es:
    sin_compra < baja < media < alta

Estrategia:
- Mapear el target a valores ordinales (0–3)
- Entrenar un modelo de regresión regularizada (ElasticNet)
- Discretizar la predicción continua a clases ordinales
- Evaluar con métricas ordinales y multiclase (NO ROC)
"""
...
# EVALUATION
# ------------------------------------------
print("MAE ordinal:", mean_absolute_error(y_test, y_pred_reg))
...
print("Modelo ordinal entrenado y evaluado correctamente")
